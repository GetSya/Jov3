...
fs.writeFileSync('./src/data/role/user.json', JSON.stringify(xeonverifieduser, null, 2))
        ...
        switch (isCommand) {
            ...
            client.sendListButtonv2(m.chat, menunya, unduh, "> Join Grup Jojo\nhttps://chat.whatsapp.com/Famd1qzPzScBX4TSual41k", {quoted: fstatus})
}
break
            case 'allmenu': {
...
client.sendMessage(m.chat, {image: fs.readFileSync("./media/theme/media/new-jobot.png"), caption: xmenu_oh, mentions: [sender]})
}
break
            /////////// MENU LAIN NYA ////////////
            case 'owner': {
            ...
            case 's': case 'sticker': case 'stiker': {
                ...
                case 'addsticker':{
                    ...
                    case 'antilink':{
                        ...
                        client.sendListButtonv2(m.chat, `Silahkan Pilih Untuk Di Aktifkan Ataupun Di Nonaktifkan`, unduh, "JoSisten", {quoted: fstatus})
                        }
                        break
                    case 'antilink->': {
...
*${prefix}deletevote* - to delete vote`
            ...
            client.sendListButtonv2(m.chat, teks_vote, unduh, "JoSisten", {quoted: fstatus})
